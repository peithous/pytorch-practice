...
def make_token_index_list_of_long_arrs(batch_text):
...
for epoch in range(20):
    for batch in train_iter:
        model.zero_grad()
        batch_input_mat = make_token_index_list_of_long_arrs(batch.text)
        target = batch.label
...
for batch in test_iter:
        ...
        bow_vector = make_token_index_list_of_long_arrs(batch.text)
